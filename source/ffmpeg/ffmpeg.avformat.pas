...
uses
  ffmpeg.log, ffmpeg.ctypes, ffmpeg.libavcodec.avcodec, ffmpeg.avio, ffmpeg.frame, ffmpeg.rational, ffmpeg.dict, ffmpeg.avutil;
...
const
  ...
  // #define AVFMT_TS_NONSTRICT $8020000 //we try to be compatible to the ABIs of ffmpeg and major forks
  // #else
  // #define AVFMT_TS_NONSTRICT $20000
  // #endif
  // /**< Format does not require strictly
  // increasing timestamps, but they must
  // still be monotonic */
  // #define AVFMT_TS_NEGATIVE  $40000 /**< Format allows muxing negative
  ...
  //
  // #define AVFMT_SEEK_TO_PTS   $4000000 /**< Seeking is based on PTS */
  //
  ...
  *)
  ...
  TAVOutputFormat = { packed } record
    ...
    *)
    ...
    interleave_packet: function(AVFormatContext: pAVFormatContext; AVPacket_out: pAVPacket; AVPacket_in: pAVPacket; flush: Integer)
      : Integer; cdecl;
    (*
  ...
  TAVInputFormat = { packed } record
    ...
    *)
    ...
    read_seek: function(AV_FormatContext: pAVFormatContext; stream_index: Integer; timestamp: int64_t; flags: Integer): Integer; cdecl;
    (*
    ...
    *)
    ...
    read_seek2: function(s: pAVFormatContext; stream_index: Integer; min_ts: int64_t; ts: int64_t; max_ts: int64_t; flags: Integer)
      : Integer; cdecl;
  end;
