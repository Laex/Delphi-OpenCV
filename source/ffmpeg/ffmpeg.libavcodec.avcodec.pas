...
unit ffmpeg.libavcodec.avcodec;
...
uses
  ffmpeg.ctypes, ffmpeg.buffer, ffmpeg.frame, ffmpeg.log, ffmpeg.rational, ffmpeg.avutil, ffmpeg.pixfmt, ffmpeg.samplefmt, ffmpeg.dict;
(*
